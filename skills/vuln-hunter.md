...
在 DawnForge 中调用某个漏洞技能时，直接说出漏洞名称即可触发对应的 skill。

## 漏洞分类索引

以下条目均对应实际存在的 `SKILL.md` 目录。普通 Markdown 资料单独放在“绕过参考文档”和“辅助参考”中，避免 DawnForge 把资料页误判为可加载技能。
...
| 技能路径 | 工具 |
|:---------|:-----|
| `pentest_skills/poxiao-src-toolkit` | 破晓 PoXiao v3.0 — SRC 挖洞工具链 |
| `pentest_skills/rayscan-scanner` | RayScan v2.0 — 全栈 Web 漏洞扫描器 |
| `pentest_skills/ruoyi-scan` | Ruoyi-Scan v1.1 — 若依框架专项 |
